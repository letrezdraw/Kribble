          ...
          <div className="waiting-animation waiting-room-layout">
            ...
            <div className="waiting-right">
              <div className="room-code-display">
                ...
                <span className="code-value">{room.id.toUpperCase()}</span>
              </div>
              <div className="waiting-players-list">
                <h4>Players in room ({room.players.length}/{room.maxPlayers || 8}):</h4>
        ...
        <div className="header-center">
          {room.phase !== 'gameEnd' && (
            <div className="game-status">
              ...
              <div className={`timer-badge ${visibleTimer <= 10 ? 'urgent' : ''}`}>
                <Clock size={16} />
                <span>{visibleTimer}s</span>
              </div>
            </div>
          )}
        </div>
