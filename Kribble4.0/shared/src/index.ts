...
// ==========================================
// CANVAS COMMAND PROTOCOL (Production Design)
// ==========================================
...
// Command history for deterministic replay
...
export interface ServerToClientEvents {
  ...
  'canvas:command': (data: { playerId: string; command: CanvasCommand }) => void;
  'canvas:sync': (data: { commands: CanvasCommand[] }) => void;
...
export interface ClientToServerEvents {
  ...
  'draw:redo': () => void;
  // Canvas Command Protocol (new unified system)
  'canvas:command': (data: { command: CanvasCommand }) => void;
